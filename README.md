...
本仓库中的配置、脚本、工作流和文档以 [MIT License](LICENSE) 发布，方便社区复用和二次维护。

固件中包含的 OpenWrt / ImmortalWrt、LuCI、内核模块和第三方软件包仍遵循各自上游项目的许可证。
...
The configuration files, scripts, workflows, and documentation in this repository are released under the [MIT License](LICENSE).

OpenWrt / ImmortalWrt, LuCI, kernel modules, and third-party packages included in built firmware images remain governed by their own upstream licenses.
